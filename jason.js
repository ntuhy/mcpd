function update() {
    //RADAR
          {
            const value1 = document.querySelector("textarea.radar1").value = `I performed an internal radar systems check at the beginning of my shift, and it passed all tests.
