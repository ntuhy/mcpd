function update() {
    //RADAR
          {
            const value1 = document.querySelector("textarea.radar1").value = `I performed an internal systems check at the beginning of my shift as I always do and it passed all tests.
