function update() {
    //RADAR
          {
            const value1 = document.querySelector("textarea.radar1").value = `I checked the calibration of my radar unit during the course of my shift, and it passed an internal systems check when it was turned on.
