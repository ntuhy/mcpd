function update() {
    //RADAR
          {
            const value1 = document.querySelector("textarea.radar1").value = `I checked the calibration of my radar unit at the beginning of my shift, and I perform an internal systems check of my radar system after each traffic stop.
